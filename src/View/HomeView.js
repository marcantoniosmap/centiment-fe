    ...
    return(
       <div className="backgroundDefault py-5">
        <div className="container">
          ...
          <div className="px-4 py-2 " style={{backgroundColor:'white', filter: 'drop-shadow(0px 3px 6px rgba(0, 0, 0, 0.288))'}} >
            ...
            <tbody>
              {
                fakeCoin.map((singleItem,index)=>(
                  <tr key={index} onClick={()=>handleClick(singleItem)}>
                    ...
                    <td className="py-0" >
                      ...
                      <span className={`px-2 indicatorHome ${fakeCoinInfoData[singleItem].priceDiff>0? 'textGreen': 'textRed'}`}><TopArrow isGreen={fakeCoinInfoData[singleItem].priceDiff>0}/> {Math.abs(fakeCoinInfoData[singleItem].priceDiff)}%</span>
                      </div>
                    </td>
                    ...
                    <td className="py-0">
                      <div className="py-4 d-flex justify-content-end">
                        ...
                        <span className={`px-2 indicatorHome ${fakeCoinInfoData[singleItem].volumeDiff>0? 'textGreen': 'textRed'}`}><TopArrow isGreen={fakeCoinInfoData[singleItem].volumeDiff>0}/> {Math.abs(fakeCoinInfoData[singleItem].volumeDiff)}%</span>
                      </div>
                    </td>
                    ...
                    <td className="py-0">
                      <div className="py-4 d-flex justify-content-end">
                        ...
                        <span className={`px-2 indicatorHome ${fakeCoinInfoData[singleItem].sentimentDiff>0? 'textGreen': 'textRed'}`}><TopArrow isGreen={fakeCoinInfoData[singleItem].sentimentDiff>0}/> {Math.abs(fakeCoinInfoData[singleItem].sentimentDiff)}%</span>
                        </div>
                    </td>
                    ...
                    <td className="py-0">
                      <div className="py-4 d-flex justify-content-end">
                        ...
                        <span className={`px-2 indicatorHome ${fakeCoinInfoData[singleItem].tweetCountDiff>0? 'textGreen': 'textRed'}`}><TopArrow isGreen={fakeCoinInfoData[singleItem].tweetCountDiff>0}/> {Math.abs(fakeCoinInfoData[singleItem].tweetCountDiff)}%</span>
                        </div>
                    </td>
                    {/* {
